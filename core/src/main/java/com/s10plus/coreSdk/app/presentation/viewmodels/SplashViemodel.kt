...
import com.s10plus.coreSdk.utils.NetworkConneccionChecked
import com.s10plus.coreSdk.utils.PersonalInformation
import com.s10plus.coreSdk.utils.ReadJSONFromAssets
import com.s10plus.coreSdk.utils.getCurentLocation
            ...
            getConfigurationUseCase.invoke(sessionDelegate.getId()).onResult(
                {
                    if (it != null) {
                        ...
                        if (it.personalInformation != null) {
                            ...
                            _showInformationPersonal.value = it.personalInformation != null
                        }
